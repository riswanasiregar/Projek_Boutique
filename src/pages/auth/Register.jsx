...
export default function Register() {
  ...
  function validate() {
    ...
    else if (!hasMin8 || !hasUpper)
      e.password = "Password belum memenuhi syarat.";
  ...
  return (
    <div style={font}>
      <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {[
              ...
              <div
                ...
                style={{
                  ...
                  color: hint.met ? "#ffffff" : "rgba(255,255,255,0.55)",
                  border: `1px solid ${hint.met ? "rgba(255,255,255,0.5)" : "rgba(255,255,255,0.2)"}`,
                }}
              >
                <BsCheckCircle
                  size={11}
                  style={{
                    color: hint.met ? "#ffffff" : "rgba(255,255,255,0.4)",
                  }}
                />
                {hint.label}
              </div>
        ...
        {/* Signup button — gradient-primary sama dengan Login */}
        <button
          type="submit"
          className="w-full py-3 rounded-xl text-sm font-bold tracking-wide transition-all hover:opacity-90 flex items-center justify-center"
          style={{
            background: "var(--gradient-primary)",
            color: "#ffffff",
            boxShadow: "0 4px 20px rgba(18,50,136,0.4)",
            ...font,
          }}
        >
          Signup
      ...
      >
        Already Account?{" "}
        <Link to="/login" className="font-bold hover:underline text-primary-1">
          Login Here
        </Link>
      </p>
    </div>
